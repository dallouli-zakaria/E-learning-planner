<x-layout>
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    <header class="text-center">
      <h2 class="text-2xl font-bold uppercase mb-1">Create a Session</h2>
      <p class="mb-4">Post a session for studnets to join</p>
    </header>
    ...
    <form method="POST" action="/sessions" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        ...
        <input type="datetime-local" class="border border-gray-200 rounded p-2 w-full" name="date"  value="{{old('date')}}" />
      ...
      <div class="mb-6">
        ...
        <a href="/sessions" class="text-black ml-4"> Back </a>
      </div>
    </form>
  </x-card>
</x-layout>
